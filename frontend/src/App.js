        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2">
            <div className="flex items-center">
              <span className="text-2xl font-bold text-teal-500">Ops</span>
              <span className="text-2xl font-bold text-orange-500">Vantage</span>
            </div>
            <div className="text-2xl font-bold text-blue-600">Digital</div>
          </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-sm rounded-lg mt-2 p-4 shadow-lg">
            <div className="flex flex-col space-y-4">
              ...
              <Link to="/services" className="nav-link-mobile" onClick={() => setIsMenuOpen(false)}>Services</Link>
              <Link to="/portfolio" className="nav-link-mobile" onClick={() => setIsMenuOpen(false)}>Portfolio</Link>
              <Link to="/store" className="nav-link-mobile" onClick={() => setIsMenuOpen(false)}>Store</Link>
    ...
    <div className="services-page pt-20">
      ...
      <section className="py-20 bg-gradient-to-br from-teal-500 to-blue-600 text-white relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 hero-text">Our Services</h1>
  ...
  return (
    <div className="store-page pt-20">
      ...
      <section className="py-20 bg-gradient-to-br from-teal-500 to-blue-600 text-white relative">
        <div className="absolute inset-0 bg-black bg-opacity-20"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 hero-text">Digital Store</h1>
          <p className="text-xl max-w-3xl mx-auto hero-description">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/store" className="text-gray-300 hover:text-teal-400 transition-colors">Digital Store</Link></li>
